...
async function main() {
  ...
  // Create sample jobs with simple IDs
  ...
  // Create sample candidates with simple IDs
  const candidates = await Promise.all([
    prisma.candidate.upsert({
      where: { id: "seed-cand-001" },
      update: {},
      create: {
        id: "seed-cand-001",
        tenantId: tenant.id,
  ...
  // Create sample applications with simple IDs
