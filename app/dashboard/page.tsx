        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Manage job postings and create new positions</p>
            </div>
          </div>
        </Link>
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Review candidates and manage hiring pipeline</p>
            </div>
          </div>
        </Link>
      </div>
